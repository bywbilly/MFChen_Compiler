...
____getTrue____function:
	sub $sp, $sp, 128

____getTrue_0____enter:

____getTrue_1____entry:
	li $v0, 1

____getTrue_2____exit:
	addu $sp, $sp, 128
	jr $ra

____getFalse____function:
	sub $sp, $sp, 128

____getFalse_0____enter:

____getFalse_1____entry:
	li $v0, 0

____getFalse_2____exit:
	addu $sp, $sp, 128
	jr $ra
...
____main_1____entry:
	jal ____getTrue____function
	move $t0, $v0
	beqz $t0, ____main_3____logical_false

____main_4____logical_merge:
	jal ____getFalse____function
	move $t0, $v0
	li $t1 1
	beqz $t0, ____main_7____if_merge

____main_5____if_true:
	li $t1 2

____main_7____if_merge:
	jal ____getTrue____function
	move $t0, $v0
	beqz $t0, ____main_10____logical_merge

____main_11____if_true:
	mul $t0, $t1, 4
	move $t1, $t0

____main_13____if_merge:
	move $a0, $t1
	jal ____builtin____print_int
	li $v0, 0
	j ____main_14____exit

____main_10____logical_merge:
	jal ____getFalse____function
	move $t0, $v0
	beqz $t0, ____main_13____if_merge
	j ____main_11____if_true

____main_3____logical_false:
	li $t1 1
	j ____main_7____if_merge
