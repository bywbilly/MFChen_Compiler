...
____main_0____enter:
	...
	sw $a3, 0($t0)
	addu $t0, $t0, 4
	sw $t0, ____global_1____variable
...
____main_2____for_condition:
	li $a3, 10
	bge $t1, $a3, ____main_5____for_merge
...
____main_5____for_merge:
	move $a0, $t3
	jal ____builtin_array____size
	move $t2, $v0
	li $t1 0

____main_6____for_condition:
	li $a3, 10
	bge $t1, $a3, ____main_9____for_merge
...
____main_10____exit:
	...
	sw $t3, ____global_1____variable
	lw $ra, 124($sp)
	addu $sp, $sp, 192
	jr $ra
