...
public class naiveTranslate{
    ...
    public void Init(ArrayList<Instruction> _ILOCLIST, HashMap<String, Integer> _registerTable, ArrayList<String> _globalRegister, Integer _maxOffset) {
        ILOCLIST = _ILOCLIST;
            ...
            if (entry.opCode.equals("beginGlobal")) {
                ...
                if (entry.opCode.equals("lw")) {
                    ...
                    if (nxtEntry.opCode.equals("li") || nxtEntry.opCode.equals("lw")) {
                        //System.out.println("!!");
                        if ((nxtEntry.source1.equals(entry.source1))) {
                            System.out.println(entry);
...
*/
            ...
            if (instr.opCode.equals("loadAI")) {
                ...
                String t_0   = change(Rdest, 0);
                String t_1   = change(Rsrc, 1);
            ...
            if (instr.opCode.equals("mult")) {
                ...
                */
                String t_0 = change(Rdest, 0);
                String t_1 = change(Rsrc1, 1);
                String t_2 = change(Rsrc2, 2);
            ...
            if (instr.opCode.equals("cmp_EQ")) {
                ...
                /*
                if (trans(Rsrc1) != "!") {
                  //  System.out.println(instr + " " + Rsrc1 + "!");
                    addInstruction("seq", t0, null, trans(Rsrc1), Rsrc2);
                    addInstruction("sw", t0, null, getRNum(Rdest) + pfp, null);
                    continue;
                }

                addInstruction("lw", t1, null, getRNum(Rsrc1) + pfp, null);
                if (Rsrc2.indexOf("r") != -1) {
                    addInstruction("lw", t2, null, getRNum(Rsrc2) + pfp, null);
                    addInstruction("seq", t0, null, t1, t2);
                } else {
                    addInstruction("seq", t0, null, t1, Rsrc2);
                }
                addInstruction("sw", t0, null, getRNum(Rdest) + pfp, null);
                */
            }
            ...
            if (instr.opCode.equals("iwillcall")) {
                ...
                //addInstruction("add", sp, null, sp, instr.source1);
            ...
            if (instr.opCode.equals("stringPlus")) {
                ...
                addInstruction("true_for_stringplus1" + tottalStringPlus + ":", null, null, null, null);
                ...
                addInstruction("bne", s6, zero, "true_for_stringplus1" + tottalStringPlus, null);
                addInstruction("beq", s6, zero, "false_for_stringplus1" + tottalStringPlus, null);
                addInstruction("false_for_stringplus1" + tottalStringPlus + ":", null, null, null, null);
                tottalStringPlus++;
