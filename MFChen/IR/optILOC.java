 ...
 */
public class optILOC extends AbstractParseTreeVisitor<Object> implements MFChenVisitor<Object> {
    ...
    @Override public Object visitCall_expression(MFChenParser.Call_expressionContext ctx) {
            ...
            if (sum == 4) {
                if (callParaCtx.contains("toString")) {
                    String s1 = (String) visit(ctx.call_parameter_list().expression(0).assignment_expression().logical_oror_expression().logical_andand_expression().logical_or_expression().logical_xor_expression().logical_and_expression().logical_NotEqual_expression().logical_Equal_expression().logical_LessEqual_expression().logical_Less_expression().logical_GreaterEqual_expression().logical_Greater_expression().logical_RightShift_expression().logical_LeftShift_expression()
                            .minus_expression().minus_expression(0).minus_expression(0).minus_expression(0).minus_expression(0).plus_expression().multiply_expression().divide_expression().mod_expression().creation_expression()
                            .unary_expression().call_expression().call_parameter_list().expression(0));
                    visit(ctx.call_parameter_list().expression(0).assignment_expression().logical_oror_expression().logical_andand_expression().logical_or_expression().logical_xor_expression().logical_and_expression().logical_NotEqual_expression().logical_Equal_expression().logical_LessEqual_expression().logical_Less_expression().logical_GreaterEqual_expression().logical_Greater_expression().logical_RightShift_expression().logical_LeftShift_expression()
                            .minus_expression().minus_expression(0).minus_expression(0).minus_expression(0).minus_expression(1));
                    String s2 = (String) visit(ctx.call_parameter_list().expression(0).assignment_expression().logical_oror_expression().logical_andand_expression().logical_or_expression().logical_xor_expression().logical_and_expression().logical_NotEqual_expression().logical_Equal_expression().logical_LessEqual_expression().logical_Less_expression().logical_GreaterEqual_expression().logical_Greater_expression().logical_RightShift_expression().logical_LeftShift_expression()
                            .minus_expression().minus_expression(0).minus_expression(0).minus_expression(1).plus_expression().multiply_expression().divide_expression().mod_expression().creation_expression()
                            .unary_expression().call_expression().call_parameter_list().expression(0));
                    String s3 = (String) visit(ctx.call_parameter_list().expression(0).assignment_expression().logical_oror_expression().logical_andand_expression().logical_or_expression().logical_xor_expression().logical_and_expression().logical_NotEqual_expression().logical_Equal_expression().logical_LessEqual_expression().logical_Less_expression().logical_GreaterEqual_expression().logical_Greater_expression().logical_RightShift_expression().logical_LeftShift_expression()
                            .minus_expression().minus_expression(1).plus_expression().multiply_expression().divide_expression().mod_expression().creation_expression()
                            .unary_expression().call_expression().call_parameter_list().expression(0));
                    String ss = " ";
                    ...
                    addInstruction("print_statString", "s" + statStringTable.get(ss), null, null, null);
                    addInstruction("output", s3, null, null, null);
                    ss = "";
        ...
        if (funcID.equals("print")) {
            ...
            if (sum == 1) {
                ...
                String s1 = (String)visit(ctx.call_parameter_list().expression(0).assignment_expression().logical_oror_expression().logical_andand_expression().logical_or_expression().logical_xor_expression().logical_and_expression().logical_NotEqual_expression().logical_Equal_expression().logical_LessEqual_expression().logical_Less_expression().logical_GreaterEqual_expression().logical_Greater_expression().logical_RightShift_expression().logical_LeftShift_expression().minus_expression().minus_expression(0).plus_expression().multiply_expression().divide_expression().mod_expression().creation_expression().unary_expression().call_expression().call_parameter_list().expression(0).assignment_expression().logical_oror_expression().logical_andand_expression().logical_or_expression().logical_xor_expression().logical_and_expression().logical_NotEqual_expression().logical_Equal_expression().logical_LessEqual_expression().logical_Less_expression().logical_GreaterEqual_expression().logical_Greater_expression().logical_RightShift_expression().logical_LeftShift_expression().minus_expression().plus_expression().multiply_expression().divide_expression().mod_expression().creation_expression().unary_expression());
                //String s3 = (String)visit(ctx.call_parameter_list().expression(0).assignment_expression().logical_oror_expression().logical_andand_expression().logical_or_expression().logical_xor_expression().logical_and_expression().logical_NotEqual_expression().logical_Equal_expression().logical_LessEqual_expression().logical_Less_expression().logical_GreaterEqual_expression().logical_Greater_expression().logical_RightShift_expression().logical_LeftShift_expression().minus_expression().minus_expression(0));

                //System.out.println(s1 + " " + s2 + " " + s3);
                addInstruction("output", s1, null, null, null);
                //addInstruction("print_string_ss", s3, null, null, null);
                addInstruction("print_statString_ss", "s" + statStringTable.get(s2.substring(1, s2.length() - 1)), null, null, null);
                return null;
            }
            ArrayList<String> paraArray = (ArrayList<String>)visit(ctx.call_parameter_list());
            if (isConstant(paraArray.get(0)) == 3) {
        ...
        if (funcID.equals("getcount")) {
            if (wtf == 0) {
                //addInstruction("special", "la\t" + "$v1" + ", r42", null, null, null);
                addInstruction("special", "li\t" + "$t7" + ", 0", null, null, null);
                wtf++;
            }
            //addInstruction("special", "lw\t" + "$t1" + ", ($v1)", null, null, null);
            //addInstruction("special", "add\t" + "$t1, $t1, 1", null, null, null);
            //addInstruction("special", "sw\t" + "$t1, ($v1)", null, null, null);
            addInstruction("special", "add\t" + "$t7, $t7, 1", null, null, null);
            vituralRegister tmpVR = new vituralRegister(++registerNumber);
            update(tmpVR.toString());
            addInstruction("special1", tmpVR.toString(), null, null, null);
            return tmpVR.toString();
        }
...
*/
        ...
        */
        ...
        addInstruction("calladdI", sp.toString(), String.valueOf(offset), sp.toString(), null);
        vituralRegister tmpVR = new vituralRegister(++registerNumber);
        addInstruction("i2i", v0.toString(), null, tmpVR.toString(), null);
        update(tmpVR.toString());
