package MFChen.Symbol;

import java.util.Enumeration;

/**
 * Created by bywbilly on 16/3/29.
 */
...
public class Table {
    ...
    public String toString() {
        String ret = "";
        Enumeration<Symbol> entry = dict.keys();
        while(entry.hasMoreElements()) {
            Object obj = (Object)entry.nextElement();
            ret += (String)obj + " ";
            ret += dict.get(dict.get(Symbol.symbol((String)obj))) + "\n";
        }
        return ret;
    }
}
