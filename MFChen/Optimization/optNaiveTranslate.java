 ...
 */
public class optNaiveTranslate{
    ...
    public ArrayList<Integer> canOPT = new ArrayList<>();
    public ArrayList<Integer> canOPT1 = new ArrayList<>();
    public ArrayList<Integer> canOPT2 = new ArrayList<>();
    public ArrayList<Integer> canOPT3 = new ArrayList<>();
    public ArrayList<Integer> canOPT4 = new ArrayList<>();
...
/*
        for (int i = 0; i < mipsList.size(); i++) {
            ...
            if (entry.opCode.equals("beginGlobal")) {
                ...
                if (entry.opCode.equals("move")) {
                    mipsInstruction nxtInstr = mipsList.get(i + 1);
                    if (nxtInstr.opCode.equals("move")) {
                        if (entry.target1.equals(nxtInstr.source1) && entry.target1.equals(v0)) {
                            entry.target1 = nxtInstr.target1;
                            i++;
                        }
                    }
                }
...
*/
        ArrayList<mipsInstruction> mipsList2 = new ArrayList<>();
        for (int i = 0; i < mipsList.size(); i++) {
            //System.out.println(entry);
            mipsInstruction entry = mipsList.get(i);
            if (entry.opCode.equals("setStaticString")) {
            ...
            if (entry.opCode.equals("beginGlobal")) {
                ...
                mipsList2.add(entry);
                if (canOPT.contains(i)) {
                    canOPT2.add(mipsList2.size() - 1);
                }
                //output.write(entry.toString());
                if (entry.opCode.equals("Label") && entry.source1.equals("main")) {
                    //System.out.println("!!! " + entry.toString());
                    for (mipsInstruction globalInstr : globalInstruction) {
                        mipsList2.add(globalInstr);
        ...
        int optForHorse2 = 0;
        int inMain = 0;
        ArrayList<mipsInstruction> mipsList3 = new ArrayList<>();
        for (int i = 0; i < mipsList2.size(); i++) {
            mipsInstruction entry = mipsList2.get(i);
            mipsInstruction nx1 = null, nx2 = null, nx3 = null;
            if (i + 4 < mipsList2.size()) {
                nx1 = mipsList2.get(i + 1);
                nx2 = mipsList2.get(i + 2);
                nx3 = mipsList2.get(i + 3);
                if (nx1.opCode.equals("sw") && nx3.opCode.equals("sw")) {
                    if (entry.opCode.equals("add") || entry.opCode.equals("div") || entry.opCode.equals("sub") || entry.opCode.equals("mul") || entry.opCode.equals("and") || entry.opCode.equals("or") || entry.opCode.equals("rem")) {
                        if (nx2.opCode.equals("add") || nx2.opCode.equals("div") || nx2.opCode.equals("sub") || nx2.opCode.equals("mul") || entry.opCode.equals("and") || entry.opCode.equals("or") || entry.opCode.equals("rem")) {
                            if (entry.source1.equals(nx2.source1)) {
                                if (nx1.target1.equals(nx3.target1) && nx1.source1.equals(nx3.source1)) {
                                    if (nx1.source1.equals(entry.source1)) {
                                        i++;
                                    }
                                }
                            }
                ...
                if (entry.opCode.equals("li") && entry.target1.equals("0")) {
                    if ((nx1.opCode.equals("sw") || nx1.opCode.equals("sb")) && nx1.source1.equals(entry.source1)) {
                        nx1.source1 = "$0";
                        continue;
                    }
                }
            ...
            if (entry.opCode.equals("Label") && entry.source1.equals("main")) {
                inMain = 1;
                mipsList3.add(entry);
                mipsList3.add(new mipsInstruction("li", "$s6", null, "16", null));
                mipsList3.add(new mipsInstruction("li", "$t9", null, "1", null));
                mipsList3.add(new mipsInstruction("li", "$t8", null, "4", null));
                mipsList3.add(new mipsInstruction("li", "$t6", null, "2", null));
                mipsList3.add(new mipsInstruction("li", "$v1", null, "8", null));
                continue;
            }
            /*
            if (inMain == 1 && entry.opCode.equals("li") && entry.source1.equals("$t0") && entry.target1.equals("0")) {
                if (optForHorse2 > 0 && optForHorse2 <= 1) {
                    optForHorse2++;
                    continue;
                } else {
                    optForHorse2++;
            ...
            */
            mipsList3.add(entry);
            if (canOPT2.contains(i)) {
                canOPT3.add(mipsList3.size() - 1);
            }
            //output.write(entry.toString());
        }

        ArrayList<mipsInstruction> mipsList4 = new ArrayList<>();

        for (int i = 0; i < mipsList3.size(); i++) {
            mipsInstruction entry = mipsList3.get(i);
            mipsInstruction nx1 = null, nx2 = null, nx3 = null;
            if (i + 4 < mipsList3.size()) {
                nx1 = mipsList3.get(i + 1);
                nx2 = mipsList3.get(i + 2);
                nx3 = mipsList3.get(i + 3);

                if (entry.opCode.equals("sw") && nx1.opCode.equals("lw")) {
                    if (entry.source1.equals(nx1.source1) && entry.target1.equals(nx1.target1)) {
                        i++;
                    }
                }

                if (entry.opCode.equals("lw") && nx1.opCode.equals("sw")) {
                    if (entry.source1.equals(nx1.source1) && entry.target1.equals(nx1.target1)) {
                        i++;
                    }
                }

                if (entry.opCode.equals("li") && entry.target1.equals("1")) {
                    if ((nx1.opCode.equals("sw") || nx1.opCode.equals("sb")) && nx1.source1.equals(entry.source1)) {
                       // System.out.print(entry.toString());
                       // System.out.println(nx1.toString());
                        nx1.source1 = "$t9";
                        continue;
                    }
                }

                if (entry.opCode.equals("li") && entry.target1.equals("2")) {
                    if ((nx1.opCode.equals("sw") || nx1.opCode.equals("sb")) && nx1.source1.equals(entry.source1)) {
                        // System.out.print(entry.toString());
                        // System.out.println(nx1.toString());
                        nx1.source1 = "$t6";
                ...
                if (entry.opCode.equals("li") && entry.target1.equals("4")) {
                    if ((nx1.opCode.equals("sw") || nx1.opCode.equals("sb")) && nx1.source1.equals(entry.source1)) {
                        // System.out.print(entry.toString());
                        // System.out.println(nx1.toString());
                        nx1.source1 = "$t8";
                ...
                if (entry.opCode.equals("li") && entry.target1.equals("8")) {
                    if ((nx1.opCode.equals("sw") || nx1.opCode.equals("sb")) && nx1.source1.equals(entry.source1)) {
                        // System.out.print(entry.toString());
                        // System.out.println(nx1.toString());
                        nx1.source1 = "$v1";
                ...
                if (entry.opCode.equals("li") && entry.target1.equals("16")) {
                    if ((nx1.opCode.equals("sw") || nx1.opCode.equals("sb")) && nx1.source1.equals(entry.source1)) {
                        // System.out.print(entry.toString());
                        // System.out.println(nx1.toString());
                        nx1.source1 = "$s6";
                ...
                if (entry.opCode.equals("slt") || entry.opCode.equals("sgt") || entry.opCode.equals("sle") || entry.opCode.equals("sge") || entry.opCode.equals("seq") || entry.opCode.equals("sne")) {
                    if (entry.target2.equals("4")) {
                        entry.target2 = "$t8";
                    }
                    if (entry.target2.equals("2")) {
                        entry.target2 = "$t6";
                    }
                    if (entry.target2.equals("1")) {
                        entry.target2 = "$t9";
                    }
                    if (entry.target2.equals("8")) {
                        entry.target2 = "$v1";
                    }
                    if (entry.target2.equals("0")) {
                        entry.target2 = "$0";
                    }
                    if (entry.target2.equals("16")) {
                        entry.target2 = "$s6";
                    }
                }

                if (entry.opCode.equals("add") || entry.opCode.equals("sub") || entry.opCode.equals("mul") || entry.opCode.equals("div") || entry.opCode.equals("and") || entry.opCode.equals("or") || entry.opCode.equals("rem")) {
                    if (entry.target2 != null) {
                        if (entry.target2.equals("4")) {
                            entry.target2 = "$t8";
                        }
                        if (entry.target2.equals("2")) {
                        ...
                        /*
                        if (entry.target1.equals("4")) {
                            entry.target1 = "$t8";
                        }
                        if (entry.target1.equals("2")) {
                            entry.target1 = "$t6";
                        }
                        if (entry.target1.equals("1")) {
                            entry.target1 = "$t9";
                        }
                        */
                    }
                ...
                if (entry.opCode.equals("lw") && nx1.opCode.equals("sw")) {
                    if (entry.target1.equals(nx1.target1)) {
                        continue;
                    }
                }
            ...
            mipsList4.add(entry);
            if (canOPT3.contains(i)) {
                canOPT4.add(mipsList4.size() - 1);
            }
            //output.write(entry.toString());
        }

        ArrayList<mipsInstruction> mipsList5 = new ArrayList<>();
        int trigger_for_magic = 0;

        for (int i = 0; i < mipsList4.size(); i++) {
            mipsInstruction entry = mipsList4.get(i);
            mipsInstruction nx1 = null, nx2 = null, nx3 = null;
            if (i + 4 < mipsList4.size()) {
                nx1 = mipsList4.get(i + 1);
                nx2 = mipsList4.get(i + 2);
                nx3 = mipsList4.get(i + 3);
                if (entry.opCode.equals("#hhh")) {
                    trigger_for_magic = 1;
                    continue;
                }
                /*
                if (canOPT4.contains(i)) {
                    trigger_for_magic = 1;
                }
                */
                if (entry.opCode.equals("slt") && (trigger_for_magic == 1)) {
                    entry.opCode = "bge";
                    entry.source1 = entry.target1;
                    entry.source2 = entry.target2;
                    entry.target1 = nx2.target1;
                    entry.target2 = null;
                    i += 2;
                    trigger_for_magic = 0;
                }
                if (entry.opCode.equals("sle") && (trigger_for_magic == 1)) {
                    entry.opCode = "bgt";
                    entry.source1 = entry.target1;
                    entry.source2 = entry.target2;
                    entry.target1 = nx2.target1;
                ...
                if (entry.opCode.equals("sge") && (trigger_for_magic == 1)) {
                    entry.opCode = "blt";
                    entry.source1 = entry.target1;
                    entry.source2 = entry.target2;
                    entry.target1 = nx2.target1;
                ...
                if (entry.opCode.equals("sgt") && (trigger_for_magic == 1)) {
                    entry.opCode = "ble";
                    entry.source1 = entry.target1;
                    entry.source2 = entry.target2;
                    entry.target1 = nx2.target1;
                ...
                if (entry.opCode.equals("seq") && (trigger_for_magic == 1)) {
                    entry.opCode = "bne";
                    entry.source1 = entry.target1;
                    entry.source2 = entry.target2;
                    entry.target1 = nx2.target1;
                ...
                if (entry.opCode.equals("sne") && (trigger_for_magic == 1)) {
                    entry.opCode = "beq";
                    entry.source1 = entry.target1;
                    entry.source2 = entry.target2;
                    entry.target1 = nx2.target1;
        ...
        ArrayList<mipsInstruction> mipsList6 = new ArrayList<>();

        for (int i = 0; i < mipsList5.size(); i++) {
            mipsInstruction entry = mipsList5.get(i);
            mipsInstruction nx1 = null, nx2 = null, nx3 = null;
            if (i + 4 < mipsList5.size()) {
                nx1 = mipsList5.get(i + 1);
                nx2 = mipsList5.get(i + 2);
                nx3 = mipsList5.get(i + 3);
                if (entry.opCode.equals("lw") && nx1.opCode.equals("sw")) {
                    if (entry.target1.equals(nx1.target1)) {
                        continue;
                    }
        ...
        for (int i = 0; i < mipsList6.size(); i++) {
            mipsInstruction entry = mipsList6.get(i);
            if (i + 4 < mipsList6.size()) {
                mipsInstruction nx1, nx2, nx3, nx4;
                //nx1 = nx2 = nx3 = nx4 = null;
                nx1 = mipsList6.get(i + 1);
                nx2 = mipsList6.get(i + 2);
                nx3 = mipsList6.get(i + 3);
                nx4 = mipsList6.get(i + 4);
                /*
                if (entry.opCode.equals("lw") && entry.source1.equals("$t1") && entry.target1.equals("-8($fp)")) {
                    if (nx1.opCode.equals("mul") && nx1.source1.equals("$t0") && nx1.target1.equals("$t1") && nx1.target2.equals("$t6")) {
                        if (nx2.opCode.equals("sw") && nx2.source1.equals("$t0") && nx2.target1.equals("-28($fp)")) {
                            nx4.source1 = "$t0";
                            output.write(entry.toString());
                            output.write(nx1.toString());
                            output.write(nx4.toString());
                            i += 4;
                            continue;
                        }
                    }
                ...
                */
                if (entry.opCode.equals("mul") || entry.opCode.equals("add") || entry.opCode.equals("sub") || entry.opCode.equals("div") || entry.opCode.equals("rem")) {
                    if (nx1.opCode.equals("sw") && nx2.opCode.equals("lw") && nx3.opCode.equals("sw") && entry.target2.equals("$t6")) {
                        if (nx1.source1.equals(entry.source1) && nx2.source1.equals(nx3.source1) && nx1.target1.equals(nx2.target1) && entry.target1.equals(nx3.source1)) {
                           // entry.source1 = entry.target1;
                            nx3.source1 = nx1.source1;
                            output.write(entry.toString());
                            //output.write(nx1.toString());
                            output.write(nx3.toString());
                            i += 3;
                            continue;
                        }
                    }
    ...
    public String getRNum(String Rdest) {
        if (Rdest.indexOf("r") == -1 || globalRegister.contains(Rdest)) {
            return Rdest;
        }
        if (trans(Rdest) != "!") {
            return trans(Rdest);
        ...
        for (int i = 0; i < ILOCLIST.size(); i++) {
            ...
            if (instr.opCode.equals("Label")) {
                ...
                if (labelName.length() >= 4 && labelName.substring(0, 4).equals("main")) {
                    ...
                    //addInstruction("li", "$t9", null, String.valueOf(1), null);
                } else {
...
*/
                if (Rsrc.contains("@") == false) {
                    ...
                    addInstruction("li", "$t7", null, Imm, null);
            ...
            if (instr.opCode.equals("i2i")) {
                ...
                if (Rdest.contains("@")) {
                    addInstruction("sw", t_1, null, address(t0)   , null);
                } else {
                    if (trans(Rdest) == "!") {
                        addInstruction("sw", t_1, null, getRNum(Rdest), null);
                    } else {
                        addInstruction("move", t_0, null, t_1, null);
                    }
                }
                /*
                if (trans(Rdest) == "!" && trans(Rsrc) == "!") {
                   // addInstruction("fuckfuckfuck" + " " + instr.toString(), null, null, null, null);

                    addInstruction("lw", t1, null, getRNum(Rsrc), null);
                    addInstruction("move", t0, null, t1, null);
                    addInstruction("sw", t0, null, getRNum(Rdest), null);

                    //addInstruction("fuckfuckfuck" + " ", null, null, null, null);
                } else {
                  if (trans(Rdest) != "!") {
                      if (trans(Rsrc) != "!") {
                          addInstruction("move", trans(Rdest), trans(Rsrc), null, null);
                      } else {
                          addInstruction("lw", t0, null, getRNum(Rsrc), null);
                          addInstruction("move", trans(Rdest), t0, null, null);
                      }
                  } else {
                      addInstruction("lw", t0, null, getRNum(Rdest), null);
                      addInstruction("move", t0, null, trans(Rsrc), null);
                      addInstruction("sw", t0, null, getRNum(Rdest), null);
                  }
                }
                */
            ...
            if (instr.opCode.equals("mult")) {
                ...
                addInstruction("sw", t0, null, getRNum(Rdest) , null);
                */
                if (Rdest.equals(Rsrc1)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("mul", t_0, null, t_0, t_2);
                    if (Rdest.contains("@")) {
                    ...
                    //System.out.println("! ! !" + Rdest + " " + Rsrc1);
                }
                if (Rsrc1.equals(Rsrc2)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("mul", t_0, null, t_2, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("multI")) {
                ...
                String Rsrc  = instr.source1;
                String Imm   = instr.source2;
                if (Rdest.equals(Rsrc)) {
                    String t_0 = change(Rdest, 0, 1);
                    addInstruction("mul", t_0, null, t_0, Imm);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("add")) {
                ...
                if (Rdest.equals(Rsrc1)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("add", t_0, null, t_0, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
                ...
                if (Rsrc1.equals(Rsrc2)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("add", t_0, null, t_2, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("addI")) {
                ...
                if (Rdest.equals(Rsrc)) {
                    String t_0 = change(Rdest, 0, 1);
                    addInstruction("add", t_0, null, t_0, Imm);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("rem")) {
                ...
                if (Rdest.equals(Rsrc1)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("rem", t_0, null, t_0, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("remI")) {
                ...
                if (Rdest.equals(Rsrc)) {
                    String t_0 = change(Rdest, 0, 1);
                    addInstruction("rem", t_0, null, t_0, Imm);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("sub")) {
                ...
                if (Rdest.equals(Rsrc1)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("sub", t_0, null, t_0, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
                ...
                if (Rsrc1.equals(Rsrc2)) {
                    ...
                    //String t_2   = change(Rsrc2, 2, 1);
                    //addInstruction("mul", t_0, null, t_2, t_2);
                    addInstruction("li", t_0, null, "0", null);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("subI")) {
                ...
                if (Rdest.equals(Rsrc)) {
                    String t_0 = change(Rdest, 0, 1);
                    addInstruction("sub", t_0, null, t_0, Imm);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("div")) {
                ...
                if (Rdest.equals(Rsrc1)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("div", t_0, null, t_0, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("divI")) {
                ...
                if (Rdest.equals(Rsrc)) {
                    String t_0 = change(Rdest, 0, 1);
                    addInstruction("div", t_0, null, t_0, Imm);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("or")) {
                ...
                if (Rdest.equals(Rsrc1)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("or", t_0, null, t_0, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("orI")) {
                ...
                if (Rdest.equals(Rsrc)) {
                    String t_0 = change(Rdest, 0, 1);
                    addInstruction("or", t_0, null, t_0, Imm);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("and")) {
                ...
                if (Rdest.equals(Rsrc1)) {
                    String t_0   = change(Rdest, 0, 1);
                    String t_2   = change(Rsrc2, 2, 1);
                    addInstruction("and", t_0, null, t_0, t_2);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("andI")) {
                ...
                if (Rdest.equals(Rsrc)) {
                    String t_0 = change(Rdest, 0, 1);
                    addInstruction("and", t_0, null, t_0, Imm);
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
                    } else {
                        if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("#hhh")) {
                trigger_for_iteration = 1;
                addInstruction("#hhh", null, null, null, null);
                canOPT.add(mipsList.size());
            }
            ...
            if (instr.opCode.equals("cmp_LT")) {
                ...
                String Rsrc2 = instr.source2;
                String Rdest = instr.target1;
                Instruction nxtInstr = ILOCLIST.get(i + 1);
                /*
                if (nxtInstr.opCode.equals("cbr")) {
                    String t_1 = change(Rsrc1, 1, 1);
                    String t_2 = change(Rsrc2, 2, 1);
                    addInstruction("blt", t_1, t_2, nxtInstr.target2, null);
                    i++;
                } else
                */
            ...
            if (instr.opCode.equals("cmp_EQ")) {
                ...
                Instruction nxtInstr = ILOCLIST.get(i + 2);
                if (nxtInstr.opCode.equals("bne") || nxtInstr.opCode.equals("beq")) {
                    //continue;
                } else {
                    if (Rdest.contains("@")) {
                        addInstruction("sw", t_0, null, address(t0), null);
            ...
            if (instr.opCode.equals("iwillcall")) {
               ...
               */
                ...
                addInstruction("add", sp, null, sp, String.valueOf(-240 + nowOffset.get(Integer.valueOf(instr.source1))));
            ...
            if (instr.opCode.equals("get_size")) {
                ...
                */
                ...
                //addInstruction("move", t_0, null, t_1, null);
                addInstruction("lw", t_0, null, address(t_1), null);
                if (Rdest.contains("@")) {
                    addInstruction("sw", t_0, null, address(t0), null);
                } else {
                    if (trans(Rdest) == "!") {
            ...
            if (instr.opCode.equals("stringLess")) {
                ...
                addInstruction("slt", t3, null, s3, s0);
                addInstruction("and", s5, null, s7, t3);
                addInstruction("bnez", s5, null, "string_less3" + stringLessNum, null);
                addInstruction("beqz", t3, null, "shit" + stringLessNum, null);
            ...
            if (instr.opCode.equals("special1")) {
                addInstruction("sw", "$s0", null, getRNum(instr.source1), null);
            }
            ...
            if (instr.opCode.equals("stringPlus")) {
                ...
                addInstruction("add", s4, null, s4, String.valueOf("3"));
                tottalStringPlus++;
                addInstruction("move", s5, null, t_1, null);
                if (Rsrc1.contains("s") == false) {
                    addInstruction("add", s5, null, s5, String.valueOf(3));
                } else {
                    addInstruction("sub", s5, null, s5, String.valueOf(1));
                }
               ...
               //addInstruction("beq", s6, zero, "false_for_stringplus1" + tottalStringPlus, null);
                addInstruction("bge", s3, s1, "false_for_stringplus1" + tottalStringPlus, null);
                ...
                //addInstruction("bne", s6, zero, "true_for_stringplus1" + tottalStringPlus, null);
                //addInstruction("beq", s6, zero, "false_for_stringplus1" + tottalStringPlus, null);
                addInstruction("blt", s3, s1, "true_for_stringplus1" + tottalStringPlus, null);
                ...
                //addInstruction("bne", s6, zero, "true_for_stringplus1" + tottalStringPlus, null);
                //addInstruction("beq", s6, zero, "false_for_stringplus1" + tottalStringPlus, null);
                addInstruction("bgt", s3, s2, "false_for_stringplus1" + tottalStringPlus, null);
                addInstruction("Label", "true_for_stringplus1" + tottalStringPlus, null, null, null);
                addInstruction("add", s4, null, s4, String.valueOf(1));
                addInstruction("add", s5, null, s5, String.valueOf(1));
                addInstruction("lb" , s7, null, address(s5), null);
               ...
               // addInstruction("bne", s6, zero, "true_for_stringplus1" + tottalStringPlus, null);
               // addInstruction("beq", s6, zero, "false_for_stringplus1" + tottalStringPlus, null);
                addInstruction("blt", s3, s2, "true_for_stringplus1" + tottalStringPlus, null);
                addInstruction("Label", "false_for_stringplus1" + tottalStringPlus, null, null, null);
                addInstruction("add", s4, null, s4, String.valueOf(1));
