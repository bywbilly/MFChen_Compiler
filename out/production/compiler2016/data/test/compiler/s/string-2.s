...
____main_1____entry:
	la $v1, ____global_2____string
	move $t0, $v1
	li $t1 0

____main_2____for_condition:
	move $a0, $t0
	jal ____builtin_string____length
	move $t2, $v0
	bge $t1, $t2, ____main_5____for_merge

____main_4____for_loop:
	move $a0, $t0
	move $a1, $t1
	jal ____builtin_string____ord
	move $t2, $v0
	move $a0, $t2
	jal ____builtin____print_int
	la $a0, ____global_6____string
...
____string_newline:
	...
	.align 2
	.word 20
____global_2____string:
	.asciiz "too young too simple"
	.align 2
	.word 0
____global_6____string:
	.asciiz ""
	.align 2
