...
____main_2____for_condition:
	li $a3, 2
	bge $t5, $a3, ____main_9____for_merge
...
____main_4____for_condition:
	li $a3, 5
	bge $t2, $a3, ____main_8____for_loop
...
____main_10____for_condition:
	li $a3, 10
	bge $t2, $a3, ____main_13____for_merge
...
____main_12____for_loop:
	...
	sw $t1, 0($t0)
	addu $t2, $t2, 1
	j ____main_10____for_condition
...
____main_14____for_condition:
	li $a3, 5
	bge $t5, $a3, ____main_17____for_merge
...
____main_16____for_loop:
	...
	addu $t0, $t0, $t1
	addu $t5, $t5, 1
	j ____main_14____for_condition

____main_17____for_merge:
	li $t5 0

____main_18____for_condition:
	li $a3, 10
	bge $t5, $a3, ____main_21____for_merge

____main_20____for_loop:
	mul $t1, $t5, 4
	addu $t1, $t7, $t1
	lw $t1, 0($t1)
	addu $t0, $t0, $t1
	addu $t5, $t5, 1
	j ____main_18____for_condition

____main_21____for_merge:
	move $a0, $t0
